<div class="footer-for-mobile bg-light py-2 shadow-sm">
    <div class="container-fluid">
        <div class="d-flex justify-content-between">
            <div class="text-center position-relative">
                ...
                <h6 class="fs-xs mb-0 mt-2 fw-normal text-uppercase">Speciality</h6>
                <a href="/<?php echo env('APP_URL'); ?>" class="stretched-link"></a>
            </div>
            <div class="text-center position-relative">
                ...
                <h6 class="fs-xs mb-0 mt-2 fw-normal text-uppercase">Doctors</h6>
            ...
            <div class="text-center position-relative">
                ...
                <h6 class="fs-xs mb-0 mt-2 fw-normal text-uppercase">Clinics</h6>
            ...
            <div class="text-center position-relative">
                ...
                <h6 class="fs-xs mb-0 mt-2 fw-normal text-uppercase">Blogs</h6>
                <a href="<?php echo env('APP_URL'); ?>/blog" class="stretched-link"></a>
            ...
            <div class="text-center position-relative">
                ...
                <a href="#" class="stretched-link" type="button" data-bs-toggle="offcanvas"
