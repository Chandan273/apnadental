    ...
    <div class="row py-4 g-3">
        <div class="col-6">
            <div class="bg-white text-center rounded-2 specialized-item p-4 position-relative">
                <div
                    class="p-2 img-wrap bg-primary d-flex align-items-center justify-content-center rounded-pill mb-4 position-relative">
                ...
                <a href="/Search-by-clinic.html" class="stretched-link"></a>
            </div>
        </div>
        <div class="col-6">
            <div class="bg-white text-center rounded-2 specialized-item p-4 position-relative">
