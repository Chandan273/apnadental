    ...
    <div class="home-page-mobile-hidden">
                                ...
                                <li>
                                    <form>
                                        <div class="form-check align-items-center">
                                            <input type="checkbox" class="form-check-input" id="compareDoctor9" data-bs-toggle="offcanvas" data-bs-target="#compareOff">
        ...
        <div class="confused-help-offcanvas">
            ...
            <div class="offcanvas offcanvas-end border-0" tabindex="-1" id="offcanvasRight"
                ...
                <div class="offcanvas-header bg-transparent justify-content-end mt-2">
                ...
                <div class="offcanvas-body">
                    ...
                    <div class="container">
                        <h2 class="fs-5 mb-3 text-center">Finding the right dental treatment is now easy</h2>
                        <div class="step-form-wraper">
                            <ul class="d-flex justify-content-between">
                                <li class="completed">
                                    <div class="step-circle d-flex align-items-center justify-content-center rounded-circle p-2 z-3">1</div>
                                    <h6>Step 1</h6>
                                </li>
                                <li class="completed">
                                    <div class="step-circle d-flex align-items-center justify-content-center rounded-circle p-2 z-3">2</div>
                                    <h6>Step 2</h6>
                                </li>
                                <li>
                                    <div class="step-circle d-flex align-items-center justify-content-center rounded-circle p-2 z-3">3</div>
                                    <h6>Step 3</h6>
                                </li>
                                <li>
                                    <div class="step-circle d-flex align-items-center justify-content-center rounded-circle p-2 z-3">4</div>
                                    <h6>Step 4</h6>
                                </li>
                            </ul>

                            <div class="step-jurney-wraper">
                                <div class="step-content-item">
                                    <div class="text-center mb-4">                                  
                                        <h3 class="fs-4">Tell us your oral health concern and we will help you with the required treatment</h3>
                                    </div>
                            ...
                            <div class="mt-2 gap-3 text-center">
                                <button class="btn btn_pink" type="button">Back</button>
                                <button class="btn btn_pink" type="button">Next</button>
                            </div>
